...
public class ParquetOptions {
  ...
  public Optional<Long> metadataSizeHint() {
    List<Long> metadataSizeHint = new ArrayList<>();
    SessionConfig.getParquetOptionsMetadataSizeHint(config.getPointer(), metadataSizeHint::add);
    return metadataSizeHint.size() == 0 ? Optional.empty() : Optional.of(metadataSizeHint.get(0));
  }
  ...
  public ParquetOptions withMetadataSizeHint(Optional<Long> metadataSizeHint) {
    ...
    SessionConfig.setParquetOptionsMetadataSizeHint(config.getPointer(), hasValue, value);
    return this;
  }
